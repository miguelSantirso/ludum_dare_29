package space_digger 
{
	 ...
	 */	
	public class CustomEnemy extends Box2DPhysicsObject
	{
		...
		protected var _enemyClass:* = CustomHero;
		...
		public function CustomEnemy(name:String, params:Object=null)
		{
		...
		override public function handleBeginContact(contact:b2Contact):void {
			...
			if (contact.GetManifold().m_localPoint) {
				...
				if ((collider is Platform && collisionAngle != 90) || collider is CustomEnemy)
					turnAround();
			}
